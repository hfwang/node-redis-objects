...
exports.prototype.keys = function(callback) {
  this.redis().hkeys(this.key, this.makeArrayCallback(callback, this.options.keyMarshaller));
};
...
exports.prototype.values = function(callback) {
  this.redis().hvals(this.key, this.makeArrayCallback(callback));
};
...
exports.prototype.bulkSet = function(values, callback /* = null */) {
  ...
  this.redis().hmset(args, callback);
};
...
exports.prototype.fill = function(values, callback /* = null */) {
  ...
  async.mapSeries(args, function(arg, cb) {
    redis.hsetnx(arg, cb);
  }, callback);
};
...
/**
 * Increments the value by integer at field.
 *
 * Redis: HINCRBY
 */
